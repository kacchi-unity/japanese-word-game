...
public class ScrollBarManager : MonoBehaviour
{
    ...
    public DifficultyController.Setting targetSetting;
    ...
    public void UpdateSliderFromInput()
    {
        ...
        if (float.TryParse(this.input.text, out float value))
        {
            ...
            this.input.text = clampValue.ToString();
        }
    ...
    public void UpdateSliderValue(DifficultyController.SettingValues valueClass)
    {
        this.slider.value = valueClass.GetValue(this.targetSetting);
        this.input.text = this.slider.value.ToString();
    }
}
